...
<?php   
if (is_home() || is_page()) {
    $description = "优格传媒，专注传媒教育";
    $keywords = "传媒, 传媒培训, 优格传媒";   
}   
elseif (is_single()) {   
...
<?php $favicon = get_option('edunews_favicon'); if(empty($favicon)) { $favicon = get_template_directory_uri()."/favicon.ico"; }?>
<link rel="shortcut icon" href="<?php echo $favicon;?>" /> 
<link href="<?php bloginfo('stylesheet_url'); ?>" rel="stylesheet" type="text/css">
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/pptBox.js"></script>
<?php wp_head(); ?>
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/css/lrtk.css" />
</head>
<body>
<div id="header">
	<div class="container">
		<div id="navigation" class="navbar">
			<div class="pull-left" style="width:300px;;height:90px;">
				<?php
                $logo = get_option('edunews_logo');
                if(empty($logo)) {
                $logo = get_template_directory_uri()."/img/logo.png";
             }?>
				<a href="<?php echo get_bloginfo('home'); ?>/"><img src="<?php echo $logo; ?>" alt="logo"/></a>
			</div>
