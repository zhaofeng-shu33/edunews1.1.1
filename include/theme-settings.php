...
function edunews_setting_function(){add_theme_page( 'edunews主题设置标题', '主题设置', 'administrator', 'edunews_setting','display_function');}   
add_action('admin_menu', 'edunews_setting_function');   
function display_function(){  
	//加载upload.js文件   
    wp_enqueue_script('my-upload', get_bloginfo( 'stylesheet_directory' ) . '/include/upload.js');   
    //加载上传图片的js(wp自带)   
    ...
    <form method="post" name="ashu_form" id="ashu_form" action="options.php">   
		...
		<table class="form-table">
			<tbody>
				<tr>
					<th>自定义logo</th>
					<td>
						<input type="text" size="80"  name="edunews_logo" id="" value="<?php echo get_option('edunews_logo'); ?>"/>   
						<input type="button" name="upload_button" class="upload_img" value="上传" />
						<br/>
						<span class="description">上传你的logo图片（logo尺寸建议为200x60，png格式）</span>
					</td>
				</tr>
				<tr>
					<th>自定义favicon</th>
					<td>
						<input type="text" size="80"  name="edunews_favicon" id="" value="<?php echo get_option('edunews_favicon'); ?>"/>   
						<input type="button" name="upload_button" class="upload_img" value="上传" />
						<br/>
						<span class="description">上传你的favicon图片，最好是ico格式的</span>
					</td>
				</tr>
				<tr>
					<th>“我们是谁”</th>
					<td>
						<input name="who_we_are" size="40" value="<?php echo get_option('who_we_are'); ?>" />
						<input type="text" size="40"  name="who_we_are_img" id="" value="<?php echo get_option('who_we_are_img'); ?>"/>   
						<input type="button" name="upload_button" class="upload_img" value="上传" />
						<br/>
						<span class="description">请输入首页“我们是谁”的文字介绍和图片(宽度不小于620px)</span>
					</td>
				</tr>
				<tr>
					<th>“我们做什么”</th>
					<td>
						<input name="what_we_do" size="40" value="<?php echo get_option('what_we_do'); ?>" />
						<input type="text" size="40"  name="what_we_do_img" id="" value="<?php echo get_option('what_we_do_img'); ?>"/>   
						<input type="button" name="upload_button" class="upload_img" value="上传" />
						<br/>
						<span class="description">请输入首页“我们做什么”的文字介绍和图片(宽度不小于280px)</span>
					</td>
				</tr>
				<tr>
					<th>“为什么选择我们”</th>
					<td>
						<input name="why_choose_we" size="40" value="<?php echo get_option('why_choose_we'); ?>" />
						<input type="text" size="40"  name="why_choose_we_img" id="" value="<?php echo get_option('why_choose_we_img'); ?>"/>   
						<input type="button" name="upload_button" class="upload_img" value="上传" />
						<br/>
						<span class="description">请输入首页“为什么选择我们”的文字介绍(宽度不小于280px)</span>
					</td>
				</tr>
				<tr>
					<th>首页分类1</th>
					<td>
						...
						<br/>
						<span class="description">选择首页tab里的显示的分类1</span>
					</td>
				</tr>
				<tr>
					<th>首页分类2</th>
					<td>
						...
						wp_dropdown_categories($args); ?>
						<br/>
						<span class="description">选择首页tab里的显示的分类2</span>
					</td>
				</tr>
				<tr>
					<th>首页分类3</th>
					<td>
						...
						wp_dropdown_categories($args); ?>
						<br/>
						<span class="description">选择首页tab里的显示的分类3</span>
					</td>
				</tr>
				<tr>
					<th>首页分类4</th>
					<td>
						...
						wp_dropdown_categories($args); ?>
						<br/>
						<span class="description">选择首页tab里的显示的分类4</span>
					</td>
				</tr>
				<tr>
					<th>幻灯片分类</th>
					<td>
						...
						wp_dropdown_categories($args); ?>
						<br/>
						<span class="description">选择幻灯片显示的分类</span>
					</td>
				</tr>
				<tr>
					<th>新浪微博</th>
					<td>
						<input name="sina_url" size="40" value="<?php echo get_option('sina_url'); ?>" />
						<br/>
						<span class="description">请输入新浪微博地址</span>
					</td>
				</tr>
				<tr>
					<th>腾讯微博</th>
					<td>
						<input name="qweibo_url" size="40" value="<?php echo get_option('qweibo_url'); ?>" />
						<br/>
						<span class="description">请输入腾讯微博地址</span>
					</td>
				</tr>
				<tr>
					<th>RSS</th>
					<td>
						<input name="rss_url" size="40" value="<?php echo get_option('rss_url'); ?>" />
						<br/>
						<span class="description">请输入RSS订阅地址</span>
					</td>
				</tr>
				<tr>
					<th>联系邮箱</th>
					<td>
						<input name="contact_email" size="40" value="<?php echo get_option('contact_email'); ?>" />
						<br/>
						<span class="description">请输入联系邮箱</span>
					</td>
				</tr>
				<tr>
					<th>联系地址</th>
					<td>
						<input name="contact_address" size="40" value="<?php echo get_option('contact_address'); ?>" />
						<br/>
						<span class="description">请输入联系地址</span>
					</td>
				</tr>
				<tr>
					<th>联系电话</th>
					<td>
						<input name="contact_phone" size="40" value="<?php echo get_option('contact_phone'); ?>" />
						<br/>
						<span class="description">请输入联系电话</span>
					</td>
				</tr>
				<tr>
					<th>QQ在线代码</th>
					<td>
						<textarea name="qq_code" id="" rows="6" cols="80"><?php $val= get_option('qq_code'); echo stripslashes($val);?></textarea>
						<br/>
						<span class="description">请输入QQ在线代码</span>
					</td>
				</tr>
				<tr>
					<th>统计代码</th>
					<td>
						<textarea name="tongji_code" id="" rows="6" cols="80"><?php $val= get_option('tongji_code'); echo stripslashes($val);?></textarea>
						<br/>
						<span class="description">请输入网站统计代码</span>
					</td>
				</tr>
			</tbody>
		</table>
		...
		<input type="hidden" name="page_options" value="who_we_are,who_we_are_img,what_we_do,what_we_do_img,why_choose_we,why_choose_we_img,sina_url,qweibo_url,rss_url,contact_email,contact_address,contact_phone,qq_code,edunews_logo,edunews_favicon,tab_cat_1,tab_cat_2,tab_cat_3,tab_cat_4,img_cat,tongji_code" />     
		<p class="submit">   
			<input type="submit" name="option_save" value="<?php _e('保存设置'); ?>" />   
		</p> 
	</form>
	<p><?php echo $theme_data['Name'] ?>主题版权属 <a href="http://www.iphonepad.cn/">Iphonepad</a>所有 | <a href="http://www.iphonepad.cn">爱疯派对</a></p>
