...
get_header();
$tab_cat_1 = get_option('tab_cat_1');
$tab_cat_2 = get_option('tab_cat_2');
$tab_cat_3 = get_option('tab_cat_3');
$tab_cat_4 = get_option('tab_cat_4');
$img_cat = get_option('img_cat');
?>
<div id="content">

	<div class="container">
		<div id="fdas" style="margin-top:-20px;margin-bottom:20px;">
		     <script>
		     var box =new PPTBox();
		     box.width = 940; //宽度
		     box.height = 320;//高度
		     ...
		     box.add({"url":"<?php bloginfo('template_url'); ?>/images/tu4.jpg","href":"http://www.talbox.cn/","title":"爱心支教"})
		     box.add({"url":"<?php bloginfo('template_url'); ?>/images/tu1.jpg","href":"http://dai.zhekoujingpin.com/?p=758","title":"中学交流"})
		     box.add({"url":"<?php bloginfo('template_url'); ?>/images/tu2.jpg","href":"http://dai.zhekoujingpin.com/?p=391","title":"爱心捐书"})
		     box.add({"url":"<?php bloginfo('template_url'); ?>/images/tu3.jpg","href":"http://dai.zhekoujingpin.com/?p=377","title":"英语口语培训"})
		     box.show();
		    </script>
		</div>
		<hr/>
		<div class="row">
			<?php get_sidebar(); ?>
			<div id="intro" class="span8" style="width:680px;">
			        ...
			        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			          <tbody><tr>
			            <td><table width="100%" border="0" cellspacing="0" cellpadding="4">
			              <tbody><tr>
			                <td width="70%" align="left"><img src="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i4.gif" width="129" height="33"></td>
			                <td width="30%" align="right" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="5">
			                  <tbody><tr>
			                    <td width="61%" align="right"><img src="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i5.gif" width="23" height="4"></td>
			                    <td width="39%" align="center"><a href="<?php echo get_category_link($tab_cat_1); ?>" class="black12_blue">更多快讯</a></td>
			                    </tr>
			                </tbody></table></td>
			              </tr>
			            </tbody></table></td>
			          ...
			          <tr>
			            <td><table width="100%" border="0" cellpadding="0" cellspacing="2" bgcolor="#eaeaea">
			              <tbody><tr>
			                <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			                  <tbody><tr>
			                    <td width="463"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			                      <tbody>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="14">
			  <tbody><tr>
			<td background="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i12.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tbody><tr>
			  <td width="8%" valign="top"><img src="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i10.gif" width="29" height="29"></td>
			  <td width="92%"><table width="100%" border="0" cellspacing="0" cellpadding="4">
			  <tbody><tr>
			<td align="left"><a href="<?php the_permalink() ?>" target="_blank" title="<?php the_title(); ?>" class="black14"><?php the_title(); ?></a>&nbsp;(<?php the_date_xml(); ?>)</td>
			  </tr>
          ...
          <?php endwhile; ?>
			...
			<?php endif; ?>
			                    ...
			                    <td align="left" valign="top" bgcolor="eaeaea"><table width="100%" border="0" cellspacing="0" cellpadding="14">
			                      <tbody><tr>
			                        <td>                           
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			                          <tbody><tr>
			                            <td><table width="196" border="0" cellpadding="0" cellspacing="1" bgcolor="bbbbbb">
			                              <tbody><tr>
			                                <td bgcolor="#EAEAEA">
			    <a href="/minxiandizhen2013/index.html" target="_blank">
			<img src="<?php bloginfo('template_url'); ?>/images/cnweb/2009/964.jpg" width="196" height="147" title="【专题】722岷县漳县6.6级地震 壹基金联合救灾(图)" border="0" target="_blank"></a></td>
			                              </tr>
			                            </tbody></table></td>
			                          </tr>
			                          <tr>
			                          ...
			                          <tr>
			                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			                              <tbody><tr>
			                                <td width="18%" valign="top"><img src="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i10.gif" width="29" height="29"></td>
			                                <td width="82%">
			    <a href="/minxiandizhen2013/index.html" target="_blank" title="【专题】722岷县漳县6.6级地震 壹基金联合救灾(图)" class="black12_list1">
			【专题】722岷县漳县6.6级地震 壹基金联合救灾(图)</a></td>
			                              </tr>
			                            </tbody></table></td>
			                          </tr>
			                        </tbody></table>
			          ...
			          <tr>
			            <td height="6" background="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i9.gif"></td>
			          </tr>
			        </tbody></table></td>
			      </tr>
			      ...
			      <tr>
			        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			          <tbody><tr>
			            <td><table width="100%" border="0" cellspacing="0" cellpadding="4">
			                <tbody><tr>
			                  <td width="70%" align="left"><img src="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i40.gif" width="137" height="37"></td>
			                  <td width="30%" align="right" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="5">
			                      <tbody><tr>
			                        <td width="61%" align="right"><img src="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i5.gif" width="23" height="4"></td>
			                        <td width="39%" align="center"><a href="<?php echo get_category_link($tab_cat_2); ?>" class="black12_blue">更多报道</a></td>
			                      </tr>
			                  </tbody></table></td>
			                </tr>
			            </tbody></table></td>
			          ...
			          <tr>
			            <td><table width="100%" border="0" cellpadding="0" cellspacing="2" bgcolor="#eaeaea">
			                <tbody><tr>
			                  <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			                      <tbody><tr>
			                        <td width="270" valign="top" bgcolor="#EAEAEA"><table width="100%" border="0" cellspacing="0" cellpadding="20">
			                            <tbody><tr>
			                              <td valign="top">
			  
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
			                                  <tbody><tr>
			                                    <td><table width="230" border="0" cellpadding="0" cellspacing="1" bgcolor="bbbbbb">
			                                        <tbody><tr>
			                                          <td bgcolor="#EAEAEA"><img src="<?php bloginfo('template_url'); ?>/images/cnweb/2009/964.jpg" width="230" height="150"></td>
			                                        </tr>
			                                    </tbody></table></td>
			                                  </tr>
			                                  <tr>
			                                  ...
			                                  <tr>
			                                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			                                        <tbody><tr>
			                                          <td width="16%" valign="top"><img src="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i10.gif" width="29" height="29"></td>
			                                          <td width="84%" align="left"><a href="/html/81/n-2081.html" target="_blank" title="滇川交界5.9地震行动回顾(图)" class="black12_list1">滇川交界5.9地震行动回顾(图)</a></td>
			                                        </tr>
			                                    </tbody></table></td>
			                                  </tr>
			                              </tbody></table>
			                        ...
			                        <td align="left" valign="top" background="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i12.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			                          <tbody>
			                          ...
			                          <?php
										...
										?>
			                          <tr>
			                            <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="14">
			                                <tbody><tr>
			                                  <td background="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i12.gif">
			        
			  									<table width="100%" border="0" cellspacing="0" cellpadding="0">
			                                      <tbody><tr>
			                                        <td width="8%" valign="top"><img src="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i10.gif" width="29" height="29"></td>
			                                        <td width="92%"><table width="100%" border="0" cellspacing="0" cellpadding="5">
			                                            <tbody><tr>
			                                              <td align="left"><a href="<?php the_permalink() ?>" target="_blank" title="<?php the_title(); ?>" class="black14"><?php the_title(); ?></a>&nbsp;(<?php the_date_xml(); ?>)</td>
			                                            </tr>
			                                        </tbody></table></td>
			      ...
			      <tr>
			        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			          <tbody><tr>
			            <td><table width="100%" border="0" cellspacing="0" cellpadding="4">
			                <tbody><tr>
			                  <td width="70%" align="left"><img src="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i42.gif" width="137" height="37"></td>
			                  <td width="30%" align="right" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="5">
			                      <tbody><tr>
			                        <td width="61%" align="right"><img src="<?php bloginfo('template_url'); ?>/images/cnweb/2009/i5.gif" width="23" height="4"></td>
			                        <td width="39%" align="center"><a href="<?php echo get_category_link($tab_cat_3); ?>" class="black12_blue">更多活动</a></td>
			                      </tr>
			                  </tbody></table></td>
			                </tr>
			            </tbody></table></td>
